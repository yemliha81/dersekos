...
@section('title', 'Paket Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Paket Güncelleme</h3></div>
              <div class="col-sm-6">
                                    ...
                                    <div class="card-body">
                                       <div class="">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="price" name="price" value="{{ $vip_package->price }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="image" class="form-label">Paket Görseli </label>
                                                <input type="file" class="form-control" id="image" name="image" accept="image/*" >
                                                @if($vip_package->image)
                                                    <img src="{{ asset( $vip_package->image) }}" alt="Paket Görseli" width="150" style="margin-top:10px;">
                                                @endif
                                            </div>
                                            <!-- grade selection -->
                                            <div class="mb-3">
                                                ...
                                                <select name="grade" id="grade" class="form-control" required>
                                                    ...
                                                    @for ($i = 1; $i <= 12; $i++)
                                                        <option value="{{ $i }}" {{ $vip_package->grade == $i ? 'selected' : '' }}>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        </div>
